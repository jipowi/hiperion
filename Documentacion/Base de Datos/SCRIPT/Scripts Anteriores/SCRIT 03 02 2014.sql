...
/* Created on:     3/2/2014 1:13:25 PM                          */
/*==============================================================*/
...
drop index COBERTURAS_ADD_INCENDIO_FK;

drop index COBERTURAS_ADD_INCENDIO_PK;

drop table COBERTURAS_ADD_INCENDIO;

drop index RELATIONSHIP_76_FK;

drop index COBERTURAS_ADUANERA_PK;

drop table COBERTURAS_ADUANERA;

drop index RELATIONSHIP_123_FK;

drop index COBERTURAS_AGRO_PK;

drop table COBERTURAS_AGRO;

drop index COBERTURA_BUEN_USO_FK;

drop index COBERTURAS_BUEN_USO_ANT_PK;

drop table COBERTURAS_BUEN_USO_ANT;

drop index RELATIONSHIP_78_FK;

drop index COBERTURAS_CASCO_PK;

drop table COBERTURAS_CASCO;

drop index RELATIONSHIP_84_FK;

drop index COBERTURAS_CASCO_AEREO_PK;

drop table COBERTURAS_CASCO_AEREO;

drop index RELATIONSHIP_69_FK;

drop index COBERTURAS_CESANTE_PK;

drop table COBERTURAS_CESANTE;

drop index RELATIONSHIP_99_FK;

drop index COBERTURAS_CONTRATISTA_PK;

drop table COBERTURAS_CONTRATISTA;

drop index RELATIONSHIP_72_FK;

drop index COBERTURAS_CONTRATO_PK;

drop table COBERTURAS_CONTRATO;

drop index RELATIONSHIP_96_FK;

drop index COBERTURAS_DINERO_VAL_PK;

drop table COBERTURAS_DINERO_VAL;

drop index RELATIONSHIP_55_FK;

drop index COBERTURAS_EQUIPO_PK;

drop table COBERTURAS_EQUIPO;

drop index RELATIONSHIP_93_FK;

drop index COBERTURAS_EQ_MAQ_PK;

drop table COBERTURAS_EQ_MAQ;

drop index RELATIONSHIP_88_FK;

drop index COBERTURAS_FIDELIDAD_PK;

drop table COBERTURAS_FIDELIDAD;
...
drop index COBERTURAS_GRUPO_VIDA_PK;

drop table COBERTURAS_GRUPO_VIDA;
...
drop index COBERTURAS_MATERIALES_PK;

drop table COBERTURAS_MATERIALES;

drop index RELATIONSHIP_111_FK;

drop index COBERTURAS_MONTAJE_PK;

drop table COBERTURAS_MONTAJE;
...
drop index COBERTURAS_RIESGOS_PK;

drop table COBERTURAS_RIESGOS;

drop index ROBO_COBERTURA_FK;

drop index COBERTURAS_ROBO_PK;

drop table COBERTURAS_ROBO;

drop index RELATIONSHIP_63_FK;

drop index COBERTURAS_ROTURA_PK;

drop table COBERTURAS_ROTURA;

drop index RELATIONSHIP_97_FK;

drop index COBERTURAS_SOAT_PK;

drop table COBERTURAS_SOAT;
...
drop index POLIZA_RAMO_EQUIPO_FK;
