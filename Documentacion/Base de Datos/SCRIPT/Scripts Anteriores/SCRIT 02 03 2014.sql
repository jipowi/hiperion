...
/* Created on:     3/2/2014 4:47:25 PM                          */
/*==============================================================*/
...
drop index CLAUSULAS_ADD_AGRO_PK;

drop table CLAUSULAS_ADD_AGRO;

drop index RELATIONSHIP_80_FK;

drop index CLAUSULAS_ADD_CASCO_PK;

drop table CLAUSULAS_ADD_CASCO;

drop index RELATIONSHIP_82_FK;

drop index CLAUSULAS_ADD_CASCO_AEREO_PK;

drop table CLAUSULAS_ADD_CASCO_AEREO;

drop index RELATIONSHIP_68_FK;

drop index CLAUSULAS_ADD_CESANTE_PK;

drop table CLAUSULAS_ADD_CESANTE;

drop index RELATIONSHIP_98_FK;

drop index CLAUSULAS_ADD_CONTRATISTA_PK;

drop table CLAUSULAS_ADD_CONTRATISTA;

drop index RELATIONSHIP_95_FK;

drop index CLAUSULAS_ADD_DINERO_PK;

drop table CLAUSULAS_ADD_DINERO;

drop index RELATIONSHIP_56_FK;

drop index CLAUSULAS_ADD_EQUIPO_PK;

drop table CLAUSULAS_ADD_EQUIPO;

drop index RELATIONSHIP_92_FK;

drop index CLAUSULAS_ADD_EQ_MAQ_PK;

drop table CLAUSULAS_ADD_EQ_MAQ;

drop index RELATIONSHIP_87_FK;

drop index CLAUSULAS_ADD_FIDELIDAD_PK;

drop table CLAUSULAS_ADD_FIDELIDAD;
...
drop index CLAUSULAS_ADD_MONTAJE_PK;

drop table CLAUSULAS_ADD_MONTAJE;
...
drop index CLAUSULAS_ADD_RIESGOS_PK;

drop table CLAUSULAS_ADD_RIESGOS;

drop index ROBO_CLAUSULAS_ADD_FK;

drop index CLAUSULAS_ADD_ROBO_PK;

drop table CLAUSULAS_ADD_ROBO;

drop index RELATIONSHIP_65_FK;

drop index CLAUSULAS_ADD_ROTURA_PK;

drop table CLAUSULAS_ADD_ROTURA;
...
drop index COBERT_ADD_CASCO_PK;

drop table COBERT_ADD_CASCO;

drop index RELATIONSHIP_83_FK;

drop index COBERT_ADD_CASCO_AEREO_PK;

drop table COBERT_ADD_CASCO_AEREO;

drop index RELATIONSHIP_70_FK;

drop index COBERT_ADD_CESANTE_PK;

drop table COBERT_ADD_CESANTE;

drop index RELATIONSHIP_54_FK;

drop index COBERT_ADD_EQUIPO_PK;

drop table COBERT_ADD_EQUIPO;

drop index RELATIONSHIP_91_FK;

drop index COBERT_ADD_EQ_MAQ_PK;

drop table COBERT_ADD_EQ_MAQ;

drop index RELATIONSHIP_142_FK;

drop index COBERT_ADD_INCENDIO_PK;

drop table COBERT_ADD_INCENDIO;

drop index RELATIONSHIP_114_FK;

drop index COBERT_ADD_RIESGOS_PK;

drop table COBERT_ADD_RIESGOS;

drop index ROBO_COBERTURA_ADD_FK;

drop index COBERT_ADD_ROBO_PK;

drop table COBERT_ADD_ROBO;

drop index RELATIONSHIP_64_FK;

drop index COBERT_ADD_ROTURA_PK;

drop table COBERT_ADD_ROTURA;

drop index RELATIONSHIP_76_FK;

drop index COBERT_ADUANERA_PK;

drop table COBERT_ADUANERA;

drop index RELATIONSHIP_123_FK;

drop index COBERT_AGRO_PK;

drop table COBERT_AGRO;

drop index COBERTURA_BUEN_USO_FK;

drop index COBERT_BUEN_USO_ANT_PK;

drop table COBERT_BUEN_USO_ANT;

drop index RELATIONSHIP_78_FK;

drop index COBERT_CASCO_PK;

drop table COBERT_CASCO;

drop index RELATIONSHIP_84_FK;

drop index COBERT_CASCO_AEREO_PK;

drop table COBERT_CASCO_AEREO;

drop index RELATIONSHIP_69_FK;

drop index COBERT_CESANTE_PK;

drop table COBERT_CESANTE;

drop index RELATIONSHIP_99_FK;

drop index COBERT_CONTRATISTA_PK;

drop table COBERT_CONTRATISTA;

drop index RELATIONSHIP_72_FK;

drop index COBERT_CONTRATO_PK;

drop table COBERT_CONTRATO;

drop index RELATIONSHIP_96_FK;

drop index COBERT_DINERO_VAL_PK;

drop table COBERT_DINERO_VAL;

drop index RELATIONSHIP_55_FK;

drop index COBERT_EQUIPO_PK;

drop table COBERT_EQUIPO;

drop index RELATIONSHIP_93_FK;

drop index COBERT_EQ_MAQ_PK;

drop table COBERT_EQ_MAQ;

drop index RELATIONSHIP_88_FK;

drop index COBERT_FIDELIDAD_PK;

drop table COBERT_FIDELIDAD;

drop index GRUPO_COBERTURA_FK;

drop index COBERT_GRUPO_PK;

drop table COBERT_GRUPO;

drop index GRUPO_COBERTURA2_FK;

drop index COBERT_GRUPO_VIDA_PK;

drop table COBERT_GRUPO_VIDA;

drop index INCENDIO_COBERTURA_FK;

drop index COBERT_INCENDIO_PK;

drop table COBERT_INCENDIO;

drop index LUCRO_COBERTURA_FK;

drop index COBERT_LUCRO_PK;

drop table COBERT_LUCRO;

drop index RELATIONSHIP_74_FK;

drop index COBERT_MATERIALES_PK;

drop table COBERT_MATERIALES;

drop index RELATIONSHIP_111_FK;

drop index COBERT_MONTAJE_PK;

drop table COBERT_MONTAJE;

drop index RESP_COBERTURA_FK;

drop index COBERT_RESP_PK;

drop table COBERT_RESP;

drop index RELATIONSHIP_117_FK;

drop index COBERT_RIESGOS_PK;

drop table COBERT_RIESGOS;

drop index ROBO_COBERTURA_FK;

drop index COBERT_ROBO_PK;

drop table COBERT_ROBO;

drop index RELATIONSHIP_63_FK;

drop index COBERT_ROTURA_PK;

drop table COBERT_ROTURA;

drop index RELATIONSHIP_97_FK;

drop index COBERT_SOAT_PK;

drop table COBERT_SOAT;

drop index TRANS_COBERTURA_FK;

drop index COBERT_TRANS_PK;

drop table COBERT_TRANS;

drop index RAMO_COBERTURA_FK;

drop index COBERT_VH_PK;

drop table COBERT_VH;

drop index INCENDIO_CONDICION_PART_FK;

drop index COND_ESP_INCENDIO_PK;

drop table COND_ESP_INCENDIO;

drop index RELATIONSHIP_116_FK;

drop index COND_ESP_RIESGOS_PK;

drop table COND_ESP_RIESGOS;

drop index ROBO_COND_ESP_FK;

drop index COND_ESP_ROBO_PK;

drop table COND_ESP_ROBO;

drop index TRANS_CONDICIONES_FK;

drop index COND_ESP_TRANS_PK;

drop table COND_ESP_TRANS;

drop index RAMO_CONDICION_FK;

drop index COND_ESP_VH_PK;

drop table COND_ESP_VH;
...
drop index COND_PART_INCENDIO_PK;

drop table COND_PART_INCENDIO;

drop index RELATIONSHIP_118_FK;

drop index COND_PART_RIESGOS_PK;

drop table COND_PART_RIESGOS;

drop index RELATIONSHIP_138_FK;

drop index DEDUCIBLES_PK;

drop table DEDUCIBLES;

drop index RELATIONSHIP_60_FK;

drop index DEDUCIBLES_EQUIPO_PK;

drop table DEDUCIBLES_EQUIPO;

drop index TRANS_DEDUCIBLE_FK;

drop index DEDUCIBLES_TRANSPORTE_PK;

drop table DEDUCIBLES_TRANSPORTE;

drop index RELATIONSHIP_100_FK;

drop index DEDUCIBLES__CONTRATISTA_PK;

drop table DEDUCIBLES__CONTRATISTA;

drop index RELATIONSHIP_112_FK;

drop index DEDUCIBLES__MONTAJE_PK;

drop table DEDUCIBLES__MONTAJE;

drop index TITULAR_DEPENDIENTES_FK;

drop index DEPENDIENTES_PK;
...
drop index DET_OBJ_ASEG_EQUIPO_PK;

drop table DET_OBJ_ASEG_EQUIPO;
...
drop index OBJ_DETALLE_FK;

drop index DET_OBJ_ASEG_ROBO_PK;

drop table DET_OBJ_ASEG_ROBO;

drop index RELATIONSHIP_105_FK;

drop index DOC_CONTRATISTA_PK;

drop table DOC_CONTRATISTA;

drop index RELATIONSHIP_110_FK;

drop index DOC_MONTAJE_PK;

drop table DOC_MONTAJE;

drop index RELATIONSHIP_102_FK;

drop index ENDOSOS_CONTRATISTA_PK;

drop table ENDOSOS_CONTRATISTA;

drop index RELATIONSHIP_109_FK;

drop index ENDOSOS_MONTAJE_PK;

drop table ENDOSOS_MONTAJE;

drop index RELATIONSHIP_85_FK;

drop index EXTRAS_CASCO_AEREO_PK;

drop table EXTRAS_CASCO_AEREO;
...
drop index GARANTIAS_EQUIPO_PK;

drop table GARANTIAS_EQUIPO;
...
drop index VIDA_GRUPO_FK;

drop index GRUPOS_VIDA_PK;

drop table GRUPOS_VIDA;

drop index ASM_LIMITES_FK;

drop index LIMITES_BENEFICIOS_PK;

drop table LIMITES_BENEFICIOS;
...
drop index GRUPO_MIEMBRO2_FK;

drop index MIEMBROS_GRUPO_VIDA_PK;

drop table MIEMBROS_GRUPO_VIDA;

drop index MODALIDAD_FK;
...
drop index OBJ_ASEG_AGROPECUARIO_PK;

drop table OBJ_ASEG_AGROPECUARIO;

drop index OBJETO_ASEGURADO_FK;

drop index OBJ_ASEG_BUEN_PK;

drop table OBJ_ASEG_BUEN;

drop index RELATIONSHIP_67_FK;

drop index OBJ_ASEG_CESANTE_PK;

drop table OBJ_ASEG_CESANTE;

drop index RELATIONSHIP_101_FK;

drop index OBJ_ASEG_CONTRATISTA_PK;

drop table OBJ_ASEG_CONTRATISTA;

drop index RELATIONSHIP_135_FK;

drop index OBJ_ASEG_DINERO_VAL_PK;

drop table OBJ_ASEG_DINERO_VAL;

drop index RELATIONSHIP_140_FK;

drop index OBJ_ASEG_EQUIPO_PK;

drop table OBJ_ASEG_EQUIPO;

drop index RELATIONSHIP_90_FK;

drop index OBJ_ASEG_EQUIPO_MAQ_PK;

drop table OBJ_ASEG_EQUIPO_MAQ;
...
drop index FIDELIDAD_MODALIDAD_FK;

drop index OBJ_ASEG_MODALIDAD_PK;

drop table OBJ_ASEG_MODALIDAD;

drop index RELATIONSHIP_108_FK;

drop index OBJ_ASEG_MONTAJE_PK;

drop table OBJ_ASEG_MONTAJE;
...
drop index OBJ_ASEG_RIESGOS_PK;

drop table OBJ_ASEG_RIESGOS;

drop index ROBO_OBJETO_FK;

drop index OBJ_ASEG_ROBO_PK;

drop table OBJ_ASEG_ROBO;

drop index RELATIONSHIP_62_FK;

drop index OBJ_ASEG_ROTURA_PK;

drop table OBJ_ASEG_ROTURA;

drop index TRANSPORTE_OBJETO_ASEGURADO_FK;

drop index OBJ_ASEG_TRANSPORTE_PK;

drop table OBJ_ASEG_TRANSPORTE;
...
drop index POLIZA_RAMO_AGRO_FK;

drop index RAMO_AGROPECUARIO_PK;

drop table RAMO_AGROPECUARIO;
...
drop index POLIZA_MATERIALES_FK;

drop index RAMO_BUENA_CAL_MAT_PK;

drop table RAMO_BUENA_CAL_MAT;

drop index POLIZA_RAMO_ANTICIPO_FK;

drop index RAMO_BUEN_USO_ANT_PK;

drop table RAMO_BUEN_USO_ANT;

drop index POLIZA_RAMO_CASCO_AEREO_FK;

drop index RAMO_CASCO_AEREO_PK;

drop table RAMO_CASCO_AEREO;

drop index POLIZA_RAMO_CASCO_FK;

drop index RAMO_CASCO_MARITIMO_PK;

drop table RAMO_CASCO_MARITIMO;

drop index POLIZA_RAMO_CESANTE_ROT_MAQ_FK;

drop index RAMO_CESANTE_ROTURA_MAQ_PK;

drop table RAMO_CESANTE_ROTURA_MAQ;

drop index POLIZA_RAMO_CONTRATO_FK;

drop index RAMO_CUMPLIMIENTO_CONTRATO_PK;

drop table RAMO_CUMPLIMIENTO_CONTRATO;

drop index POLIZA_RAMO_DINERO_FK;

drop index RAMO_DINERO_VALORES_PK;

drop table RAMO_DINERO_VALORES;

drop index RELATIONSHIP_139_FK;

drop index RAMO_EQUIPO_ELECTRONICO_PK;

drop table RAMO_EQUIPO_ELECTRONICO;

drop index POLIZA_RAMO_EQUIPO_MAQ_FK;

drop index RAMO_EQUIPO_MAQUINARIA_PK;

drop table RAMO_EQUIPO_MAQUINARIA;

drop index POLIZA_RAMO_FIDELIDAD_FK;

drop index RAMO_FIDELIDAD_PK;

drop table RAMO_FIDELIDAD;

drop index POLIZA_RAMO_ADUANERA_FK;

drop index RAMO_GARANTIA_ADUANERA_PK;

drop table RAMO_GARANTIA_ADUANERA;
...
drop index RAMO_LUCRO_CESANTE_INCENDIO_PK;

drop table RAMO_LUCRO_CESANTE_INCENDIO;
...
drop index POLIZA_RAMO_RIESGOS_FK;

drop index RAMO_RIESGOS_ESP_PK;

drop table RAMO_RIESGOS_ESP;

drop index POLIZA_RAMO_CONTRATISTA_FK;

drop index RAMO_RIESGO_CONTRATISTA_PK;

drop table RAMO_RIESGO_CONTRATISTA;

drop index POLIZA_RAMO_MONTAJE_FK;

drop index RAMO_RIESGO_MONTAJE_PK;

drop table RAMO_RIESGO_MONTAJE;

drop index POLIZA_RAMO_ROBO_FK;

drop index RAMO_ROBO_ASALTO_PK;

drop table RAMO_ROBO_ASALTO;

drop index POLIZA_RAMO_ROTURA_MAQ_FK;

drop index RAMO_ROTURA_MAQUINARIA_PK;

drop table RAMO_ROTURA_MAQUINARIA;

drop index POLIZA_RAMO_SOAT_FK;

drop index RAMO_SOAT_PK;

drop table RAMO_SOAT;
...
drop index TITULAR_FK;

drop index TITULAR_PK;
...
create table COBERT_AGRO (
   ...
   ID_AGROPECUARIO      INT4                 null,
   COBERTURA            TEXT                 null,
   constraint PK_COBERT_AGRO primary key (ID_COBERTURA)
);
...
/*==============================================================*/
create  index RAMO_COBERTURA_FK on COBERT_VH (
ID_RAMO_VEHICULOS
);
...
alter table COBERT_VH
   add constraint FK_COBERT_V_RAMO_COBE_RAMO_VEH foreign key (ID_RAMO_VEHICULOS)
      references RAMO_VEHICULOS (ID_RAMO_VEHICULOS)
      on delete restrict on update restrict;
