...
/* Created on:     1/21/2014 9:08:18 AM                         */
/*==============================================================*/
...
create table COND_ESP_VH (
   ...
   ID_RAMO_VEHICULOS    INT4                 null,
   CONDICION            TEXT                 null,
   constraint PK_COND_ESP_VH primary key (ID_CONDICION_ESP)
);
...
create table DEDUCIBLES_EQUIPO (
   ...
   NUMERO_DIAS          INT4                 null,
   constraint PK_DEDUCIBLES_EQUIPO primary key (ID_DEDUCIBLE)
);
...
create table DOC_CONTRATISTA (
   ...
   DOCUMENTO            TEXT                 null,
   ESTADO               TEXT                 null,
   constraint PK_DOC_CONTRATISTA primary key (ID_DOCUMENTO)
);
...
create table ENDOSOS_CONTRATISTA (
   ...
   ENDOSO               DECIMAL              null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_ENDOSOS_CONTRATISTA primary key (ID_ENDOSO)
);
...
create table RAMO_RIESGO_MONTAJE (
   ...
   TASA                 DECIMAL              null,
   PERIODO_CONSTRUCCION INT4                 null,
   PORCEN_PERIODO_CONSTRUCCION DECIMAL              null,
   FILE_CRONOGRAMA      TEXT                 null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
