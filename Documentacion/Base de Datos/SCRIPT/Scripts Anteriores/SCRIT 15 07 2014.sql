...
/* Created on:     7/15/2014 1:31:17 PM                         */
/*==============================================================*/
...
/*==============================================================*/
/* Table: DEDUCIBLES_ROBO                                       */
/*==============================================================*/
create table DEDUCIBLES_ROBO (
   ID_DEDUCIBLE         SERIAL               not null,
   ID_ROBO              INT4                 null,
   SINIESTRO_ROBO       DECIMAL              null,
   SINIESTRO_HURTO      DECIMAL              null,
   SINIESTRO_PROPIEDAD  DECIMAL              null,
   MINIMO_ROBO          DECIMAL              null,
   MINIMO_HURTO         DECIMAL              null,
   MINIMO_PROPIEDAD     DECIMAL              null,
   constraint PK_DEDUCIBLES_ROBO primary key (ID_DEDUCIBLE)
);

/*==============================================================*/
/* Index: DEDUCIBLES_ROBO_PK                                    */
/*==============================================================*/
create unique index DEDUCIBLES_ROBO_PK on DEDUCIBLES_ROBO (
ID_DEDUCIBLE
);
...
/*==============================================================*/
create  index RELATIONSHIP_143_FK on DEDUCIBLES_ROBO (
ID_ROBO
);
...
create table DETALLE_CATALOGO (
   ...
   DET_ID_DETALLE_CATALOGO INT4                 null,
...
/*==============================================================*/
/* Index: DET_CAT_DET_CAT_FK                                    */
/*==============================================================*/
create  index DET_CAT_DET_CAT_FK on DETALLE_CATALOGO (
DET_ID_DETALLE_CATALOGO
);
...
create table FAMILIA (
   ID_DEPENDIENTE2      SERIAL               not null,
   ID_TITULAR           INT4                 null,
   FECHA_NACIMIENTO     DATE                 null,
   CEDULA               TEXT                 null,
   EDAD                 INT4                 null,
   ...
   constraint PK_FAMILIA primary key (ID_DEPENDIENTE2)
);
...
/*==============================================================*/
/* Index: TITULAR_FAMILIA_FK                                    */
/*==============================================================*/
create  index TITULAR_FAMILIA_FK on FAMILIA (
ID_TITULAR
);
...
/*==============================================================*/
/* Table: GARANTIAS_POLIZA                                      */
/*==============================================================*/
create table GARANTIAS_POLIZA (
   ID_GARANTIA_EQUIPO   SERIAL               not null,
   ID_EQUIPO            INT4                 null,
   GARANTIA             TEXT                 null,
   constraint PK_GARANTIAS_POLIZA primary key (ID_GARANTIA_EQUIPO)
);

/*==============================================================*/
/* Index: GARANTIAS_POLIZA_PK                                   */
/*==============================================================*/
create unique index GARANTIAS_POLIZA_PK on GARANTIAS_POLIZA (
ID_GARANTIA_EQUIPO
);
...
/*==============================================================*/
create  index RELATIONSHIP_53_FK on GARANTIAS_POLIZA (
ID_EQUIPO
);
...
create table OBJ_ASEG_DINERO_VAL (
   ...
   TRAYECTORIA_DESDE    TEXT                 null,
   TRAYECTORIA_HASTA    TEXT                 null,
...
/*==============================================================*/
create  index FIDELIDAD_MODALIDAD_FK on OBJ_ASEG_FIDELIDAD (
ID_FIDELIDAD
);
...
create table OBJ_ASEG_ROBO (
   ...
   UBICACION            TEXT                 null,
   DETALLE_OBJETO       TEXT                 null,
   MUEBLES              DECIMAL              null,
   JOYAS                DECIMAL              null,
   MAQUINARIA           DECIMAL              null,
   DINERO               DECIMAL              null,
   MERCADERIA           DECIMAL              null,
...
create table RAMO_EQUIPO_ELECTRONICO (
   ...
   ID_POLIZA            INT4                 null,
   TASA_FIJOS           DECIMAL              null,
   TASA_PORTADORES_EXTERNOS DECIMAL              null,
   TASA_INCREMENTO_COSTO DECIMAL              null,
   TASA_PORTATILES      DECIMAL              null,
   TASA_CELULARES       DECIMAL              null,
   TASA_HURTO           DECIMAL              null,
   TASA_OTROS           DECIMAL              null,
   SINIESTRO_FIJOS      DECIMAL              null,
   SINIESTRO_DATOS      DECIMAL              null,
   SINIESTRO_PORTATILES DECIMAL              null,
   SINIESTRO_CELULARES  DECIMAL              null,
   SINIESTRO_HURTO      DECIMAL              null,
   MINIMO_FIJOS         DECIMAL              null,
   MINIMO_DATOS         DECIMAL              null,
   MINIMO_PORTATILES    DECIMAL              null,
   MINIMO_CELULARES     DECIMAL              null,
   MINIMO_HURTO         DECIMAL              null,
   NUMERO_DIAS          INT4                 null,
...
create table RAMO_INCENDIO_LINEAS_ALIADAS (
   ...
   SINIESTRO_TERREMOTO  DECIMAL              null,
   SINIESTRO_LLUVIA     DECIMAL              null,
   SINIESTRO_OTROS      DECIMAL              null,
   SINIESTRO_VIDRIOS    DECIMAL              null,
   MINIMO_TERREMOTO     DECIMAL              null,
   MINIMO_LLUVIA        DECIMAL              null,
   MINIMO_OTROS         DECIMAL              null,
   MINIMO_VIDRIOS       DECIMAL              null,
   TASA_COMPRENSIVA     DECIMAL(8,2)         null,
   TASA_REMOCION        DECIMAL              null,
   TASA_DOCUMENTOS      DECIMAL              null,
   TASA_HONORARIOS      DECIMAL              null,
   TASA_CLAUSULA        DECIMAL              null,
...
create table RAMO_RIESGO_CONTRATISTA (
   ...
   DETALLE_OBJ_ASEGURADO DECIMAL              null,
   CONSTRUCCION_A       DECIMAL              null,
   CONSTRUCCION_B       DECIMAL              null,
   CONSTRUCCION_C       DECIMAL              null,
   CONSTRUCCION_D       DECIMAL              null,
   CONSTRUCCION_G       DECIMAL              null,
   MINIMO_A             DECIMAL              null,
   MINIMO_B             DECIMAL              null,
   MINIMO_C             DECIMAL              null,
   MINIMO_D             DECIMAL              null,
   MINIMO_G             DECIMAL              null,
...
/*==============================================================*/
/* Index: ASM_TITULAR_FK                                        */
/*==============================================================*/
create  index ASM_TITULAR_FK on TITULAR (
ID_AST_MEDICA
);
...
/*==============================================================*/
/* DBMS name:      PostgreSQL 8                                 */
/* Created on:     7/18/2014 4:53:48 PM                         */
/*==============================================================*/
...
alter table DEDUCIBLES_ROBO
   add constraint FK_DEDUCIBL_RELATIONS_RAMO_ROB foreign key (ID_ROBO)
      references RAMO_ROBO_ASALTO (ID_ROBO)
      on delete restrict on update restrict;
...
alter table DETALLE_CATALOGO
   add constraint FK_DETALLE__DET_CAT_D_DETALLE_ foreign key (DET_ID_DETALLE_CATALOGO)
      references DETALLE_CATALOGO (ID_DETALLE_CATALOGO)
      on delete restrict on update restrict;
...
alter table FAMILIA
   add constraint FK_FAMILIA_TITULAR_F_TITULAR foreign key (ID_TITULAR)
      references TITULAR (ID_TITULAR)
      on delete restrict on update restrict;
...
alter table TITULAR
   add constraint FK_TITULAR_ASM_TITUL_RAMO_ASI foreign key (ID_AST_MEDICA)
      references RAMO_ASISTENCIA_MEDICA (ID_AST_MEDICA)
      on delete restrict on update restrict;
