...
/* Created on:     01/02/2014 18:19:44                          */
/*==============================================================*/
...
/*==============================================================*/
/* Index: DEDUCIBLES_DINERO_VALORES_FK                          */
/*==============================================================*/
create  index DEDUCIBLES_DINERO_VALORES_FK on DEDUCIBLES (
ID_DINERO
);
...
alter table DEDUCIBLES
   add constraint FK_DEDUCIBL_DEDUCIBLE_RAMO_DIN foreign key (ID_DINERO)
      references RAMO_DINERO_VALORES (ID_DINERO)
      on delete restrict on update restrict;
