...
/* Created on:     1/12/2014 5:54:07 PM                         */
/*==============================================================*/
...
/*==============================================================*/
/* Table: CLAUS_ADD_CASCO_AEREO                                 */
/*==============================================================*/
create table CLAUS_ADD_CASCO_AEREO (
   ID_CLAUSULA_AD11     SERIAL               not null,
   ID_CASCO_AEREO       INT4                 null,
   CLAUSULA             TEXT                 null,
   constraint PK_CLAUS_ADD_CASCO_AEREO primary key (ID_CLAUSULA_AD11)
);

/*==============================================================*/
/* Index: CLAUS_ADD_CASCO_AEREO_PK                              */
/*==============================================================*/
create unique index CLAUS_ADD_CASCO_AEREO_PK on CLAUS_ADD_CASCO_AEREO (
ID_CLAUSULA_AD11
);
...
/*==============================================================*/
create  index RELATIONSHIP_82_FK on CLAUS_ADD_CASCO_AEREO (
ID_CASCO_AEREO
);

/*==============================================================*/
/* Table: CLAUS_ADD_CESANTE                                     */
/*==============================================================*/
create table CLAUS_ADD_CESANTE (
   ID_CLAUSULA_AD9      SERIAL               not null,
   ID_CESANTE           INT4                 null,
   CLAUSULA             TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   NUMERO_DIAS          INT4                 null,
   constraint PK_CLAUS_ADD_CESANTE primary key (ID_CLAUSULA_AD9)
);

/*==============================================================*/
/* Index: CLAUS_ADD_CESANTE_PK                                  */
/*==============================================================*/
create unique index CLAUS_ADD_CESANTE_PK on CLAUS_ADD_CESANTE (
ID_CLAUSULA_AD9
);
...
/*==============================================================*/
create  index RELATIONSHIP_68_FK on CLAUS_ADD_CESANTE (
ID_CESANTE
);

/*==============================================================*/
/* Table: CLAUS_ADD_CONTRATISTA                                 */
/*==============================================================*/
create table CLAUS_ADD_CONTRATISTA (
   ID_CLAUSULA_AD15     SERIAL               not null,
   ID_CONTRATISTA       INT4                 null,
   CLAUSULA             TEXT                 null,
   constraint PK_CLAUS_ADD_CONTRATISTA primary key (ID_CLAUSULA_AD15)
);

/*==============================================================*/
/* Index: CLAUS_ADD_CONTRATISTA_PK                              */
/*==============================================================*/
create unique index CLAUS_ADD_CONTRATISTA_PK on CLAUS_ADD_CONTRATISTA (
ID_CLAUSULA_AD15
);
...
/*==============================================================*/
create  index RELATIONSHIP_98_FK on CLAUS_ADD_CONTRATISTA (
ID_CONTRATISTA
);

/*==============================================================*/
/* Table: CLAUS_ADD_ROTURA                                      */
/*==============================================================*/
create table CLAUS_ADD_ROTURA (
   ID_CLAUSULA_AD8      SERIAL               not null,
   ID_ROTURA            CHAR(10)             null,
   CLAUSULA             TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   NUMERO_DIAS          INT4                 null,
   constraint PK_CLAUS_ADD_ROTURA primary key (ID_CLAUSULA_AD8)
);

/*==============================================================*/
/* Index: CLAUS_ADD_ROTURA_PK                                   */
/*==============================================================*/
create unique index CLAUS_ADD_ROTURA_PK on CLAUS_ADD_ROTURA (
ID_CLAUSULA_AD8
);
...
/*==============================================================*/
create  index RELATIONSHIP_65_FK on CLAUS_ADD_ROTURA (
ID_ROTURA
);
...
/*==============================================================*/
/* Table: COBERTURAS_ADD_CASCO                                  */
/*==============================================================*/
create table COBERTURAS_ADD_CASCO (
   ID_COBERTURA20       SERIAL               not null,
   ID_CASCO             INT4                 null,
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERTURAS_ADD_CASCO primary key (ID_COBERTURA20)
);

/*==============================================================*/
/* Index: COBERTURAS_ADD_CASCO_PK                               */
/*==============================================================*/
create unique index COBERTURAS_ADD_CASCO_PK on COBERTURAS_ADD_CASCO (
ID_COBERTURA20
);
...
/*==============================================================*/
create  index RELATIONSHIP_79_FK on COBERTURAS_ADD_CASCO (
ID_CASCO
);

/*==============================================================*/
/* Table: COBERTURAS_ADD_EQUIPO                                 */
/*==============================================================*/
create table COBERTURAS_ADD_EQUIPO (
   ID_COBERTURA11       SERIAL               not null,
   ID_EQUIPO            INT4                 null,
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERTURAS_ADD_EQUIPO primary key (ID_COBERTURA11)
);

/*==============================================================*/
/* Index: COBERTURAS_ADD_EQUIPO_PK                              */
/*==============================================================*/
create unique index COBERTURAS_ADD_EQUIPO_PK on COBERTURAS_ADD_EQUIPO (
ID_COBERTURA11
);
...
/*==============================================================*/
create  index RELATIONSHIP_54_FK on COBERTURAS_ADD_EQUIPO (
ID_EQUIPO
);

/*==============================================================*/
/* Table: COBERTURAS_ADD_ROBO                                   */
/*==============================================================*/
create table COBERTURAS_ADD_ROBO (
   ID_COBERTURA9        SERIAL               not null,
   ID_ROBO              INT4                 null,
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERTURAS_ADD_ROBO primary key (ID_COBERTURA9)
);

/*==============================================================*/
/* Index: COBERTURAS_ADD_ROBO_PK                                */
/*==============================================================*/
create unique index COBERTURAS_ADD_ROBO_PK on COBERTURAS_ADD_ROBO (
ID_COBERTURA9
);
...
/*==============================================================*/
create  index ROBO_COBERTURA_ADD_FK on COBERTURAS_ADD_ROBO (
ID_ROBO
);
...
create table COBERT_CASCO_AEREO (
   ...
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERT_CASCO_AEREO primary key (ID_COBERTURA21)
);
...
create table COBERT_DINERO_VAL (
   ...
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERT_DINERO_VAL primary key (ID_COBERTURA26)
);
...
create table COBERT_EQ_MAQ (
   ...
   CEBERTURA            TEXT                 null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_COBERT_EQ_MAQ primary key (ID_COBERTURA24)
);
...
create table DEDUCIBLES (
   ID_DEDUCIBLE         SERIAL               not null,
   ID_EQUIPO            INT4                 null,
   PORCENTAJE_CONSTRUCCION DECIMAL              null,
   VALOR_MINIMO         DECIMAL              null,
   NUMERO_DIAS          INT4                 null,
   constraint PK_DEDUCIBLES primary key (ID_DEDUCIBLE)
);
...
/*==============================================================*/
create  index RELATIONSHIP_60_FK on DEDUCIBLES (
ID_EQUIPO
);
...
/*==============================================================*/
/* Table: DOCUM_CONTRATISTA                                     */
/*==============================================================*/
create table DOCUM_CONTRATISTA (
   ID_DOCUMENTO         SERIAL               not null,
   ID_CONTRATISTA       INT4                 null,
   DOCUMENTO            TEXT                 null,
   ESTADO               TEXT                 null,
   constraint PK_DOCUM_CONTRATISTA primary key (ID_DOCUMENTO)
);

/*==============================================================*/
/* Index: DOCUM_CONTRATISTA_PK                                  */
/*==============================================================*/
create unique index DOCUM_CONTRATISTA_PK on DOCUM_CONTRATISTA (
ID_DOCUMENTO
);
...
/*==============================================================*/
create  index RELATIONSHIP_105_FK on DOCUM_CONTRATISTA (
ID_CONTRATISTA
);
...
create table ENDOSOS (
   ID_ENDOSO            SERIAL               not null,
   ID_CONTRATISTA       INT4                 null,
   ENDOSO               DECIMAL              null,
   VALOR                DECIMAL(8,2)         null,
   constraint PK_ENDOSOS primary key (ID_ENDOSO)
);

/*==============================================================*/
/* Index: ENDOSOS_PK                                            */
/*==============================================================*/
create unique index ENDOSOS_PK on ENDOSOS (
ID_ENDOSO
);
...
/*==============================================================*/
create  index RELATIONSHIP_102_FK on ENDOSOS (
ID_CONTRATISTA
);
...
create table GARANTIAS_EQUIPO (
   ...
   ID_EQUIPO            INT4                 null,
   GARANTIA             TEXT                 null,
   constraint PK_GARANTIAS_EQUIPO primary key (ID_GARANTIA)
);
...
create table OBJ_ASEG_EQUIPO_MAQ (
   ID_OBJETO_EQUIPO     SERIAL               not null,
   ID_EQUIPO_MAQUINARIA INT4                 null,
   ITEM                 INT4                 null,
   MARCA                TEXT                 null,
   MODELO               TEXT                 null,
   ...
   CHASIS               TEXT                 null,
   COLOR                TEXT                 null,
   constraint PK_OBJ_ASEG_EQUIPO_MAQ primary key (ID_OBJETO_EQUIPO)
);
...
/*==============================================================*/
/* Table: RAMO_BUENA_CALIDAD_MATERIALES                         */
/*==============================================================*/
create table RAMO_BUENA_CALIDAD_MATERIALES (
   ID_MATERIAL          SERIAL               not null,
   ID_POLIZA            INT4                 null,
   OBJETO_ASEGURADO     TEXT                 null,
   VALOR_CONTRATO       DECIMAL              null,
   VALOR_POLIZA         DECIMAL              null,
   SECTOR               TEXT                 null,
   TIPO_GARANTIA        TEXT                 null,
   FILE_CONTRATO        TEXT                 null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FILE_CONDICIONES_GENERALES TEXT                 null,
   constraint PK_RAMO_BUENA_CALIDAD_MATERIAL primary key (ID_MATERIAL)
);

/*==============================================================*/
/* Index: RAMO_BUENA_CALIDAD_PK                                 */
/*==============================================================*/
create unique index RAMO_BUENA_CALIDAD_PK on RAMO_BUENA_CALIDAD_MATERIALES (
ID_MATERIAL
);
...
/*==============================================================*/
create  index POLIZA_MATERIALES_FK on RAMO_BUENA_CALIDAD_MATERIALES (
ID_POLIZA
);
...
create table RAMO_CESANTE_ROTURA_MAQ (
   ...
   PORCENTAJE_CONSTRUCCION DECIMAL              null,
   MINIMO_SINIESTRO     DECIMAL              null,
   PORCENTAJE_ASEGURADO DECIMAL              null,
   MINIMO_ASEGURADO     DECIMAL              null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FILE_CONDICIONES_GENERALES TEXT                 null,
...
create table RAMO_EQUIPO_MAQUINARIA (
   ...
   MINIMO_ASEGURADO     DECIMAL              null,
   FILE_DETALLE_MAQUINARIO TEXT                 null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FILE_CONDICIONES_GENERALES TEXT                 null,
...
create table RAMO_FIDELIDAD (
   ...
   ID_POLIZA            INT4                 null,
   SECTOR               TEXT                 null,
   MODALIDAD_OBJ_ASEGURADO TEXT                 null,
   VALOR_COLUSORIO      DECIMAL              null,
   VALOR_INDIVIDUAL     DECIMAL              null,
   BLANKET              TEXT                 null,
   TASA                 DECIMAL              null,
   PORCENTAJE_SINISTRO  DATE                 null,
   MINIMO_SINIESTRO     DECIMAL              null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FILE_CONDICIONES_GENERALES TEXT                 null,
...
create table RAMO_RIESGO_CONTRATISTA (
   ...
   PORCENTAJE_PERID_CONST INT4                 null,
...
create table RAMO_ROBO_ASALTO (
   ...
   ID_POLIZA            INT4                 null,
   TASA                 DECIMAL              null,
   DEDUCIBLE_SINIESTRO  DECIMAL              null,
   VALOR_SINIESTRO      DECIMAL              null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FIEL_CONDICIONES_GENERALES TEXT                 null,
...
create table RAMO_ROTURA_MAQUINARIA (
   ID_ROTURA            CHAR(10)             not null,
   ID_POLIZA            INT4                 null,
   TASA                 DECIMAL              null,
   PORCENTAJE_CONSTRUCCION DECIMAL              null,
   MINIMO_SINIESTRO     DECIMAL              null,
   PORC_VALOR_ASEGURADO CHAR(10)             null,
   MIN_VALOR_ASEGURADO  CHAR(10)             null,
   GASTOS_EXTRAORDINARIOS DECIMAL              null,
   FLETE_AEREO          DECIMAL              null,
   FILE_POLIZA_VIGENTE  TEXT                 null,
   FILE_CONDICIONES_GENERALES TEXT                 null,
...
alter table CLAUS_ADD_CASCO_AEREO
   add constraint FK_CLAUS_AD_RELATIONS_RAMO_CAS foreign key (ID_CASCO_AEREO)
      references RAMO_CASCO_AEREO (ID_CASCO_AEREO)
      on delete restrict on update restrict;

alter table CLAUS_ADD_CESANTE
   add constraint FK_CLAUS_AD_RELATIONS_RAMO_CES foreign key (ID_CESANTE)
      references RAMO_CESANTE_ROTURA_MAQ (ID_CESANTE)
      on delete restrict on update restrict;

alter table CLAUS_ADD_CONTRATISTA
   add constraint FK_CLAUS_AD_RELATIONS_RAMO_RIE foreign key (ID_CONTRATISTA)
      references RAMO_RIESGO_CONTRATISTA (ID_CONTRATISTA)
      on delete restrict on update restrict;

alter table CLAUS_ADD_ROTURA
   add constraint FK_CLAUS_AD_RELATIONS_RAMO_ROT foreign key (ID_ROTURA)
...
alter table COBERTURAS_MATERIALES
   add constraint FK_COBERTUR_RELATIONS_RAMO_BUE foreign key (ID_MATERIAL)
      references RAMO_BUENA_CALIDAD_MATERIALES (ID_MATERIAL)
      on delete restrict on update restrict;
...
alter table DOCUM_CONTRATISTA
   add constraint FK_DOCUM_CO_RELATIONS_RAMO_RIE foreign key (ID_CONTRATISTA)
      references RAMO_RIESGO_CONTRATISTA (ID_CONTRATISTA)
      on delete restrict on update restrict;

alter table ENDOSOS
   add constraint FK_ENDOSOS_RELATIONS_RAMO_RIE foreign key (ID_CONTRATISTA)
      references RAMO_RIESGO_CONTRATISTA (ID_CONTRATISTA)
      on delete restrict on update restrict;
...
alter table RAMO_BUENA_CALIDAD_MATERIALES
