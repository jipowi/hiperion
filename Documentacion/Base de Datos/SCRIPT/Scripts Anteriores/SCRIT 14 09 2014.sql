...
/* Created on:     9/21/2014 9:10:55 PM                         */
/*==============================================================*/
...
create table ASEGURADORA (
   ...
   DIRECION             TEXT                 null,
   EMAIL                TEXT                 null,
   TELEFONO_CONVENCIONAL TEXT                 null,
...
/*==============================================================*/
/* Index: BENEFICIOS_ADC_FK                                     */
/*==============================================================*/
create  index BENEFICIOS_ADC_FK on BENEFICIOS_ADC (
ID_AST_MEDICA
);
...
/*==============================================================*/
/* Index: CLAUSULAS_ADD_CESANTE_FK                              */
/*==============================================================*/
create  index CLAUSULAS_ADD_CESANTE_FK on CLAUSULAS_ADD_CESANTE (
ID_CESANTE
);
...
/*==============================================================*/
/* Index: COBERT_CASCO_FK                                       */
/*==============================================================*/
create  index COBERT_CASCO_FK on COBERT_CASCO (
ID_CASCO
);
...
/*==============================================================*/
/* Index: COBERT_GRUPO_FK                                       */
/*==============================================================*/
create  index COBERT_GRUPO_FK on COBERT_GRUPO (
ID_GRUPO
);
...
/*==============================================================*/
/* Index: COBERT_GRUPO_VIDA_FK                                  */
/*==============================================================*/
create  index COBERT_GRUPO_VIDA_FK on COBERT_GRUPO_VIDA (
ID_GRUPO_VIDA
);
...
/*==============================================================*/
/* Index: COBERT_ROBO_FK                                        */
/*==============================================================*/
create  index COBERT_ROBO_FK on COBERT_ROBO (
ID_ROBO
);
...
/* Index: COBERT_VH_FK                                          */
/*==============================================================*/
create  index COBERT_VH_FK on COBERT_VH (
ID_RAMO_VEHICULOS
);
...
/*==============================================================*/
/* Index: COND_PART_INCENDIO_FK                                 */
/*==============================================================*/
create  index COND_PART_INCENDIO_FK on COND_PART_INCENDIO (
ID_INCENDIO
);
...
/*==============================================================*/
/* Index: DEDUCIBLES_EQUIPO_FK                                  */
/*==============================================================*/
create  index DEDUCIBLES_EQUIPO_FK on DEDUCIBLES_EQUIPO (
ID_EQUIPO
);
...
/*==============================================================*/
/* Index: DEDUCIBLES_TRANSPORTE_FK                              */
/*==============================================================*/
create  index DEDUCIBLES_TRANSPORTE_FK on DEDUCIBLES_TRANSPORTE (
ID_TRANSPORTE
);
...
/*==============================================================*/
/* Index: DEDUCIBLES__CONTRATISTA_FK                            */
/*==============================================================*/
create  index DEDUCIBLES__CONTRATISTA_FK on DEDUCIBLES__CONTRATISTA (
ID_CONTRATISTA
);
...
/*==============================================================*/
/* Index: DEDUCIBLES__MONTAJE_FK                                */
/*==============================================================*/
create  index DEDUCIBLES__MONTAJE_FK on DEDUCIBLES__MONTAJE (
ID_RIESGO_MONTAJE
);
...
/*==============================================================*/
/* Index: DET_OBJ_ASEG_EQUIPO_FK                                */
/*==============================================================*/
create  index DET_OBJ_ASEG_EQUIPO_FK on DET_OBJ_ASEG_EQUIPO (
...
/*==============================================================*/
/* Index: DET_OBJ_ASEG_INCENDIO_FK                              */
/*==============================================================*/
create  index DET_OBJ_ASEG_INCENDIO_FK on DET_OBJ_ASEG_INCENDIO (
...
/*==============================================================*/
/* Index: DET_OBJ_ASEG_ROBO_FK                                  */
/*==============================================================*/
create  index DET_OBJ_ASEG_ROBO_FK on DET_OBJ_ASEG_ROBO (
ID_OBJETO_ROBO
);
...
/*==============================================================*/
/* Index: DOC_CONTRATISTA_FK                                    */
/*==============================================================*/
create  index DOC_CONTRATISTA_FK on DOC_CONTRATISTA (
ID_CONTRATISTA
);
...
/*==============================================================*/
/* Index: DOC_MONTAJE_FK                                        */
/*==============================================================*/
create  index DOC_MONTAJE_FK on DOC_MONTAJE (
ID_RIESGO_MONTAJE
);
...
/*==============================================================*/
/* Index: ENDOSOS_CONTRATISTA_FK                                */
/*==============================================================*/
create  index ENDOSOS_CONTRATISTA_FK on ENDOSOS_CONTRATISTA (
ID_CONTRATISTA
);
...
/*==============================================================*/
/* Index: ENDOSOS_MONTAJE_FK                                    */
/*==============================================================*/
create  index ENDOSOS_MONTAJE_FK on ENDOSOS_MONTAJE (
ID_RIESGO_MONTAJE
);
...
/*==============================================================*/
/* Index: GARANTIAS_EQUIPO_FK                                   */
/*==============================================================*/
create  index GARANTIAS_EQUIPO_FK on GARANTIAS_EQUIPO (
ID_EQUIPO
);
...
/* Index: GRUPOS_FK                                             */
/*==============================================================*/
create  index GRUPOS_FK on GRUPOS (
ID_ACCIDENTES
);
...
/*==============================================================*/
/* Index: LIMITES_BENEFICIOS_FK                                 */
/*==============================================================*/
create  index LIMITES_BENEFICIOS_FK on LIMITES_BENEFICIOS (
ID_AST_MEDICA
);
...
/*==============================================================*/
/* Index: MIEMBROS_GRUPO_FK                                     */
/*==============================================================*/
create  index MIEMBROS_GRUPO_FK on MIEMBROS_GRUPO (
ID_GRUPO
);
...
/*==============================================================*/
/* Index: OBJ_ASEG_BUEN_FK                                      */
/*==============================================================*/
create  index OBJ_ASEG_BUEN_FK on OBJ_ASEG_BUEN (
IND_BUEN_USO_ANT
);
...
/*==============================================================*/
/* Index: OBJ_ASEG_CONTRATISTA_FK                               */
/*==============================================================*/
create  index OBJ_ASEG_CONTRATISTA_FK on OBJ_ASEG_CONTRATISTA (
ID_CONTRATISTA
);
...
/*==============================================================*/
/* Index: OBJ_ASEG_MODALIDAD_FK                                 */
/*==============================================================*/
create  index OBJ_ASEG_MODALIDAD_FK on OBJ_ASEG_MODALIDAD (
ID_FIDELIDAD
);
...
alter table CLAUSULAS_ADD_AGRO
   add constraint FK_CLAUSULA_CLAUSULAS_RAMO_AGR foreign key (ID_AGROPECUARIO)
      references RAMO_AGROPECUARIO (ID_AGROPECUARIO)
      on delete restrict on update restrict;
...
alter table COBERT_ADD_CASCO
   add constraint FK_COBERT_A_COBERT_AD_RAMO_CAS foreign key (ID_CASCO)
      references RAMO_CASCO_MARITIMO (ID_CASCO)
      on delete restrict on update restrict;
...
alter table COBERT_AGRO
   add constraint FK_COBERT_A_COBERTURA_RAMO_AGR foreign key (ID_AGROPECUARIO)
      references RAMO_AGROPECUARIO (ID_AGROPECUARIO)
      on delete restrict on update restrict;
...
alter table COBERT_CASCO
   add constraint FK_COBERT_C_COBERT_CA_RAMO_CAS foreign key (ID_CASCO)
      references RAMO_CASCO_MARITIMO (ID_CASCO)
      on delete restrict on update restrict;

alter table COBERT_CASCO_AEREO
   add constraint FK_COBERT_C_COBERT_CA_RAMO_CAS foreign key (ID_CASCO_AEREO)
      references RAMO_CASCO_AEREO (ID_CASCO_AEREO)
      on delete restrict on update restrict;
...
alter table COBERT_CONTRATO
   add constraint FK_COBERT_C_COBERT_CO_RAMO_CUM foreign key (ID_CONTRATO)
...
alter table COBERT_MATERIALES
   add constraint FK_COBERT_M_COBERTURA_RAMO_BUE foreign key (ID_MATERIAL)
...
alter table OBJ_ASEG_BUEN
   add constraint FK_OBJ_ASEG_OBJ_ASG_B_RAMO_BUE foreign key (IND_BUEN_USO_ANT)
      references RAMO_BUEN_USO_ANT (IND_BUEN_USO_ANT)
      on delete restrict on update restrict;
