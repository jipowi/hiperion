					...
					<tbody>
						<tr>
							<td align="center" colspan="2" style="font-weight: bold;">
								<h3>
									<xsl:text>Cotizaci&#243;n Garantia Aduanera </xsl:text>
								</h3>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<br />
								<xsl:text>Valor del contrato: </xsl:text>
								<xsl:value-of select="documento/valorColusorio" />
								<br />
								<xsl:text>Valor  p&#243;liza : </xsl:text>
								...
								<br />
								<xsl:text>Tipo de Contra garantia: </xsl:text>
								<xsl:value-of select="documento/porcentajeValorSiniestro" />
								<br />
