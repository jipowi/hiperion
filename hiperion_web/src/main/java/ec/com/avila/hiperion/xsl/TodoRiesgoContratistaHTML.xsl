					...
					<tbody>
						<tr>
							<td align="center" colspan="2" style="font-weight: bold;">
								<h3>
									<xsl:text>Cotizaci&#243;n Todo Riesgo Contratista </xsl:text>
								</h3>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<br />
								<xsl:text>Tasa Perido de Construcci&#243;n: </xsl:text>
								<xsl:value-of select="documento/tasaPeriodoConstruccion" />
								<br />
