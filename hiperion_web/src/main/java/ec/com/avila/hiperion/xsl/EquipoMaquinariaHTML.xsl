					...
					<tbody>
						<tr>
							<td align="center" colspan="2" style="font-weight: bold;">
								<h3>
									<xsl:text>Cotizaci&#243;n Equipo y Maquinaria</xsl:text>
								</h3>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<br />
								<xsl:text>Porcentaje min&#237;mo del valor asegurado : </xsl:text>
								<xsl:value-of select="documento/porcentajeMinimoValorAsegurado" />
								<br />
								<xsl:text>Min&#237;mo siniestro: </xsl:text>
								<xsl:value-of select="documento/minimoSiniestro" />
