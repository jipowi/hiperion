					...
					<tbody>
						<tr>
							<td align="center" colspan="2" style="font-weight: bold;">
								<h3>
									<xsl:text>Cotizaci&#243;n Incendio Lineas Aliadasa </xsl:text>
								</h3>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								...
								<br />
								<xsl:text>Consideraciones Importantes: </xsl:text>
								<xsl:value-of select="documento/consideracionesImportantes" />
								<br />
