...
public class CatalogoBacking implements Serializable {
	...
	public void onEdit(RowEditEvent event) throws HiperionException {
		...
		FacesMessage msg = new FacesMessage("Catalogo Editado", catalogo.getDescripcion());
		FacesContext.getCurrentInstance().addMessage(null, msg);
	}

	public void onCancel(RowEditEvent event) {
		FacesMessage msg = new FacesMessage("Catalogo Cancelado", ((Catalogo) event.getObject()).getDescripcion());
		FacesContext.getCurrentInstance().addMessage(null, msg);
	}
	...
	public void guardarCatalogo(ActionEvent event) throws HiperionException {
		...
		catalogo.setDescripcion(catalogoBean.getDescripcion());
