 ...
 * @since JDK1.6
 */
public class ObjetoAseguradoEquipoElectronicoBean implements Serializable {
	 ...
	 * @param valorObjeto
	 */
	public ObjetoAseguradoEquipoElectronicoBean(Integer numeroItem, String ubicacionRiesgo, String descripcion, String detalle, BigDecimal valorObjeto) {
		super();
