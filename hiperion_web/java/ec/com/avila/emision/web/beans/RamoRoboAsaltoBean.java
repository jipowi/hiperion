...
public class RamoRoboAsaltoBean implements Serializable {
	...
	private static final ArrayList<ObjetoAseguradoRoboBean> objetoAseguradoList = new ArrayList<ObjetoAseguradoRoboBean>();
	...
	/**
	 * @param tasaContenidos the tasaContenidos to set
	 */
	...
	/**
	 * @param detalleObjeto the detalleObjeto to set
	 */
	 ...
	 */
	public ArrayList<ObjetoAseguradoRoboBean> getObjetoaseguradolist() {
	...
	public String addActionObjeto() {
		ObjetoAseguradoRoboBean orderitem = new ObjetoAseguradoRoboBean(this.numeroItem, this.ubicacionRiesgo, this.valorDetalleObjeto,
	...
	public void onEditObjeto(RowEditEvent event) {
		FacesMessage msg = new FacesMessage("Item Edited", ((ObjetoAseguradoRoboBean) event.getObject()).getNumeroItem().toString());
	...
	public void onCancelObjeto(RowEditEvent event) {
		...
		FacesContext.getCurrentInstance().addMessage(null, msg);
		objetoAseguradoList.remove((ObjetoAseguradoRoboBean) event.getObject());
	}
