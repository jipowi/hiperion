 ...
 * @since JDK1.6
 */
public class ObjetoAseguradoCesanteILABean implements Serializable {
	...
	public ObjetoAseguradoCesanteILABean(Integer numeroItem, String ubicacionRiesgo, String formaSeguro, BigDecimal utilidad, String detalle) {
		super();
