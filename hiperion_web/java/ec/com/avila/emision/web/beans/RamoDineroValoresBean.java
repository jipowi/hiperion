...
public class RamoDineroValoresBean implements Serializable {
	...
	private static final ArrayList<ObjetoAseguradoDineroValoresBean> objetoAseguradoList = new ArrayList<ObjetoAseguradoDineroValoresBean>();
	 ...
	 */
	public ArrayList<ObjetoAseguradoDineroValoresBean> getObjetoaseguradolist() {
	...
	public String addActionObjetoAsegurado() {
		ObjetoAseguradoDineroValoresBean objetoAseguradoItem = new ObjetoAseguradoDineroValoresBean(this.item, this.dineroValores,
	...
	public void onEditObjetoAsegurado(RowEditEvent event) {
		...
		FacesMessage msg = new FacesMessage("Item Edited", ((ObjetoAseguradoDineroValoresBean) event.getObject()).getItem().toString());
	...
	public void onCancelObjetoAsegurado(RowEditEvent event) {
		...
		FacesContext.getCurrentInstance().addMessage(null, msg);
		objetoAseguradoList.remove((ObjetoAseguradoDineroValoresBean) event.getObject());
