 ...
 * @since JDK1.6
 */
public class ModalidadFamiliaBean {
	 ...
	 * @param parentesco
	 */
	public ModalidadFamiliaBean(String nombre, String cedula, Date fechaNacimiento, Integer edad, BigDecimal primaNeta, String parentesco) {
		super();
		this.nombre = nombre;
		this.cedula = cedula;
